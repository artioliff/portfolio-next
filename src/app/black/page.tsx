...
export default function BlackPage() {
  return (
    <div className="theme-black min-h-screen bg-(--background) text-(--foreground)">
      {/* Header */}
      ...
      <main id="topo" className="mx-auto max-w-5xl px-4">
        ...
        {/* Skills */}
        <section id="skills" className="mx-auto max-w-6xl p-5 bg-(--card)">
        ...
        {/* Projetos */}
        <section id="projetos" className="py-5 bg-(--card)">
        ...
        <section id="experiencia" className="py-5">
          ...
          <div className="flex flex-col gap-4 mt-4">
            {Dados.experiencia.itens.map((item) => (
              <div key={item.titulo} className="p-4 bg-(--card)">
